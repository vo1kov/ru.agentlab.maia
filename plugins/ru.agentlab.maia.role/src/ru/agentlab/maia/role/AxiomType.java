...
public enum AxiomType {
	...
	OBJECT_PROPERTY_ASSERTION(2),

	NEGATIVE_OBJECT_PROPERTY_ASSERTION(2),

	DATA_PROPERTY_ASSERTION(2),

	NEGATIVE_DATA_PROPERTY_ASSERTION(2),
	...
	SYMMETRIC_OBJECT_PROPERTY(2),

	ASYMMETRIC_OBJECT_PROPERTY(1),

	TRANSITIVE_OBJECT_PROPERTY(2),

	REFLEXIVE_OBJECT_PROPERTY(2),
