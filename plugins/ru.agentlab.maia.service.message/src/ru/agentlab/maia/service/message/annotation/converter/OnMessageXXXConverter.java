package ru.agentlab.maia.service.message.annotation.converter;

import static org.hamcrest.CoreMatchers.allOf;
import static org.hamcrest.CoreMatchers.equalTo;
import static ru.agentlab.maia.agent.filter.impl.PlanEventFilters.hamcrest;
import static ru.agentlab.maia.service.message.match.Matchers.hasContent;
import static ru.agentlab.maia.service.message.match.Matchers.hasConversationId;
import static ru.agentlab.maia.service.message.match.Matchers.hasEncoding;
import static ru.agentlab.maia.service.message.match.Matchers.hasInReplyTo;
import static ru.agentlab.maia.service.message.match.Matchers.hasLanguage;
import static ru.agentlab.maia.service.message.match.Matchers.hasOntology;
import static ru.agentlab.maia.service.message.match.Matchers.hasPerformative;
import static ru.agentlab.maia.service.message.match.Matchers.hasProtocol;
import static ru.agentlab.maia.service.message.match.Matchers.hasReplyWith;
import static ru.agentlab.maia.service.message.match.Matchers.hasSender;
