...
import ru.agentlab.maia.service.time.annotation.OnTimerDelay;

public class OnTimerDelayExtraPlansConverter implements IPlanExtraConverter {
	...
	public List<IPlan<?>> getPlans(Object role, Method method, Annotation annotation, Map<String, Object> customData) {
		...
		Runnable onStartPlan = () -> {
			...
			futures[0] = scheduler
				.schedule(() -> eventQueue.offer(new TimerEvent(eventKey)), onTimerDelay.value(), onTimerDelay.unit());
		};
