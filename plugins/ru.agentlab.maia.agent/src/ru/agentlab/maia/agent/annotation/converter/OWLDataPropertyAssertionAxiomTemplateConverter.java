...
import static ru.agentlab.maia.agent.belief.filter.Matchers.isBooleanLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isDataProperty;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isDoubleLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isFloatLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isIntegerLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isNamedIndividual;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isPlainLiteral;
import static ru.agentlab.maia.agent.belief.filter.Matchers.isTypedLiteral;
import static ru.agentlab.maia.agent.filter.impl.PlanEventFilters.allOf;
import static ru.agentlab.maia.agent.filter.impl.PlanEventFilters.anything;
import static ru.agentlab.maia.agent.filter.impl.PlanEventFilters.hamcrest;
import static ru.agentlab.maia.agent.filter.impl.PlanEventFilters.var;
