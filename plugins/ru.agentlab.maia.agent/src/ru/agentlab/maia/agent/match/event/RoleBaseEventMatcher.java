...
import ru.agentlab.maia.agent.event.RoleBaseEvent;

public class RoleBaseEventMatcher implements IEventMatcher<Class<?>> {

	Class<? extends RoleBaseEvent> eventType;

	Class<?> clazz;

	public RoleBaseEventMatcher(Class<? extends RoleBaseEvent> eventType, Class<?> template) {
