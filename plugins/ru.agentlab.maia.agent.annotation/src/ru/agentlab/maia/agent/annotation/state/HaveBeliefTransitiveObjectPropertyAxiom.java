...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsTransitiveObjectPropertyAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsTransitiveObjectPropertyAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefTransitiveObjectPropertyAxiom {
