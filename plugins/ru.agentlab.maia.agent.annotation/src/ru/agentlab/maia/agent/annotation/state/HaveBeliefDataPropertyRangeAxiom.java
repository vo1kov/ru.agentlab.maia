...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsDataPropertyRangeAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsDataPropertyRangeAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefDataPropertyRangeAxiom {
