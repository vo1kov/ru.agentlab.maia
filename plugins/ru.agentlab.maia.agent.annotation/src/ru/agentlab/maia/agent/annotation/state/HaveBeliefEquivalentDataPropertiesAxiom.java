...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsEquivalentDataPropertiesAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsEquivalentDataPropertiesAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefEquivalentDataPropertiesAxiom {
