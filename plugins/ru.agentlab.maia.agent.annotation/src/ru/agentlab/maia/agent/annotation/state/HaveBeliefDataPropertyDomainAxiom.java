...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsDataPropertyDomainAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsDataPropertyDomainAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefDataPropertyDomainAxiom {
