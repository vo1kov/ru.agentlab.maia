...
import ru.agentlab.maia.agent.annotation.internal.HaveGoalsNegativeObjectPropertyAssertionAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveGoalsNegativeObjectPropertyAssertionAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveGoalNegativeObjectPropertyAssertionAxiom {
