...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsInverseObjectPropertiesAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsInverseObjectPropertiesAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefInverseObjectPropertiesAxiom {
