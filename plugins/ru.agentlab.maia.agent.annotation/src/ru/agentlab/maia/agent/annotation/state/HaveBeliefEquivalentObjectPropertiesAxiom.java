...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsEquivalentObjectPropertiesAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsEquivalentObjectPropertiesAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefEquivalentObjectPropertiesAxiom {
