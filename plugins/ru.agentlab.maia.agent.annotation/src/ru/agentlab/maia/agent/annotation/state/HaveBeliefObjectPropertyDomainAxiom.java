...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsObjectPropertyDomainAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsObjectPropertyDomainAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefObjectPropertyDomainAxiom {
