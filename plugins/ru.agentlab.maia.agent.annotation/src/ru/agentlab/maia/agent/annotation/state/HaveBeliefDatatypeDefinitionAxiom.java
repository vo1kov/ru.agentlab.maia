...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsDatatypeDefinitionAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsDatatypeDefinitionAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefDatatypeDefinitionAxiom {
