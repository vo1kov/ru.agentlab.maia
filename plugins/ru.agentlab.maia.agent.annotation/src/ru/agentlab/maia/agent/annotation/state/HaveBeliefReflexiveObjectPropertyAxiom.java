...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsReflexiveObjectPropertyAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsReflexiveObjectPropertyAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefReflexiveObjectPropertyAxiom {
