...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsEquivalentClassesAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsEquivalentClassesAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefEquivalentClassesAxiom {
