...
import ru.agentlab.maia.agent.annotation.internal.HaveBeliefsAsymmetricObjectPropertyAxiom;
import ru.agentlab.maia.converter.PlanEventFilterConverter;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
@Repeatable(HaveBeliefsAsymmetricObjectPropertyAxiom.class)
@PlanEventFilterConverter(OnBeliefXXXConverter.class)
public @interface HaveBeliefAsymmetricObjectPropertyAxiom {
