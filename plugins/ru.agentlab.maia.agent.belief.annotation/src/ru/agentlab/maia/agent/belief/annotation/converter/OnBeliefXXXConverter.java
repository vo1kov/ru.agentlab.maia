...
import static ru.agentlab.maia.agent.belief.match.Matchers.hasClassExpression;
import static ru.agentlab.maia.agent.belief.match.Matchers.hasIRI;
import static ru.agentlab.maia.agent.belief.match.Matchers.hasIndividual;
import static ru.agentlab.maia.agent.belief.match.Matchers.hasObject;
import static ru.agentlab.maia.agent.belief.match.Matchers.hasProperty;
import static ru.agentlab.maia.agent.belief.match.Matchers.hasSubject;
import static ru.agentlab.maia.agent.belief.match.Matchers.isBooleanLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isDataProperty;
import static ru.agentlab.maia.agent.belief.match.Matchers.isDoubleLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isFloatLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isIndividual;
import static ru.agentlab.maia.agent.belief.match.Matchers.isIntegerLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isNamedClass;
import static ru.agentlab.maia.agent.belief.match.Matchers.isNamedIndividual;
import static ru.agentlab.maia.agent.belief.match.Matchers.isObjectProperty;
import static ru.agentlab.maia.agent.belief.match.Matchers.isPlainLiteral;
import static ru.agentlab.maia.agent.belief.match.Matchers.isTypedLiteral;
import static ru.agentlab.maia.agent.match.EventMatchers.allOf;
import static ru.agentlab.maia.agent.match.EventMatchers.anything;
import static ru.agentlab.maia.agent.match.EventMatchers.hamcrest;
import static ru.agentlab.maia.agent.match.EventMatchers.var;
