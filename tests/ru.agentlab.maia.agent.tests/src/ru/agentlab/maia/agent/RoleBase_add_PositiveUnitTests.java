...
public class RoleBase_add_PositiveUnitTests extends RoleBaseAbstractTest {
	...
	public static Collection<Object[]> testCases() {
        ...
        /* -------------------------------------------------------------------------------------------------------
		/*   0 */ { R1,  new IRole[]{},           true,     new IRole[]{R1},             new Object[] {added(R1)} },
		/*   1 */ { R2,  new IRole[]{R1},         true,     new IRole[]{R1, R2},         new Object[] {added(R2)} }, 
		/*   2 */ { R1,  new IRole[]{R1},         false,    new IRole[]{R1},             new Object[] {} }, 
		/*   3 */ { R4,  new IRole[]{R1, R2, R3}, true,     new IRole[]{R1, R2, R3, R4}, new Object[] {added(R4)} }, 
		/*   4 */ { R2,  new IRole[]{R1, R2, R3}, false,    new IRole[]{R1, R2, R3},     new Object[] {} }, 
		// @formatter:on
		});
	}

	@Parameter(0)
	public IRole roleToAdd;
	...
	public void evaluateTestCase() {
		...
		// When
		boolean result = roleBase.add(roleToAdd);
		// Then
		assertThat(result, equalTo(expected));
		assertThat(roleBase.getRoles(), hasItem(roleToAdd));
