...
/**
 * <p>
 * Tests for {@link IContext#set(String,Provider) IContext.set(String,Provider)}
 * method.
 * </p><p>
 ...
 * </p><ul>
 * <li>validArgs  - invoke <code>IContext.set(validKey, validProvider)</code>;</li>
 * <li>nullString  - invoke <code>IContext.set(null, validProvider)</code>;</li>
 * <li>nullProvider - invoke <code>IContext.set(validKey, null)</code>;</li>
 * <li>nullArgs - invoke <code>IContext.set(null, null)</code>;</li>
 * </ul><p>
 * Results of method tests can be proven by:
 * </p><ul>
 * <li>{@link IContext#getKeySet() IContext.getKeySet()};</li>
 * <li>{@link IContext#get(String) IContext.get(String)};</li>
 * </ul>
 */
