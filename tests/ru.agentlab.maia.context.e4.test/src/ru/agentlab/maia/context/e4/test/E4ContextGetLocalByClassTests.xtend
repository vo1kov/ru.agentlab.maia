...
import ru.agentlab.maia.context.test.AbstractContextGetLocalByClassTests

@RunWith(MockitoJUnitRunner)
class E4ContextGetLocalByClassTests extends AbstractContextGetLocalByClassTests {
