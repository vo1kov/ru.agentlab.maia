...
Examples:
|step	|A		|B		|C		|B1		|B2		|B3		|B4		|C1		|C2		|C3		|C4		|
|0		|READY	|READY	|READY	|READY	|READY	|READY	|READY	|READY	|READY	|READY	|READY	|
|1		|WORKING|WORKING|READY	|SUCCESS|READY	|READY	|READY	|READY	|READY	|READY	|READY	|
|2		|WORKING|WORKING|WORKING|SUCCESS|READY	|READY	|READY	|SUCCESS|READY	|READY	|READY	|
|3		|WORKING|WORKING|WORKING|SUCCESS|SUCCESS|READY	|READY	|SUCCESS|READY	|READY	|READY	|
|4		|WORKING|WORKING|WORKING|SUCCESS|SUCCESS|READY	|READY	|SUCCESS|SUCCESS|READY	|READY	|
|5		|WORKING|WORKING|WORKING|SUCCESS|SUCCESS|SUCCESS|READY	|SUCCESS|SUCCESS|READY	|READY	|
|6		|WORKING|WORKING|WORKING|SUCCESS|SUCCESS|SUCCESS|READY	|SUCCESS|SUCCESS|SUCCESS|READY	|
|7		|WORKING|SUCCESS|WORKING|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|READY	|
|8		|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|SUCCESS|