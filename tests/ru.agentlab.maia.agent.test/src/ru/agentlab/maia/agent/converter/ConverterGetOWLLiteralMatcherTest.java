...
public class ConverterGetOWLLiteralMatcherTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { 
			...
			/*  7 */ 	{ "?var@?lang^^rdf:XMLLiteral", 			matcher(_var("var"),			_var("lang"), 	_typ(RDF, XML_LITERAL)) }, 		// test variable value and lang
			...
			/* 15 */ 	{ "?var@?lang^^rdfs:Literal", 				matcher(_var("var"),			_var("lang"), 	_typ(RDFS, LITERAL)) }, 		// test variable value and lang
			...
			/* 27 */ 	{ "Тестовая строка@ru^^xsd:string", 		matcher(_str("Тестовая строка"),_str("ru"),	 	_typ(XSD, STRING)) }, 			// test language tag
			...
			/* 42 */ 	{ "?var@?lang^^owl:real", 					matcher(_var("var"),			_var("lang"), 	_typ(OWL, REAL)) }, 			// test variable value and lang
			...
			/* 52 */ 	{ "?var@?lang^^owl:rational", 				matcher(_var("var"),			_var("lang"), 	_typ(OWL, RATIONAL)) }, 		// test variable value and lang
			...
			/* 63 */ 	{ "?var@?lang^^xsd:string", 				matcher(_var("var"),			_var("lang"), 	_typ(XSD, STRING)) }, 			// test variable value and lang
			...
			/* 74 */ 	{ "?var@?lang^^xsd:normalizedString", 		matcher(_var("var"),			_var("lang"), 	_typ(XSD, NORMALIZED_STRING))}, // test variable value and lang
			...
			/*  0 */ 	{ "-0^^xsd:boolean", 						LiteralNotInLexicalSpaceException.class },										// wrong value format
			/*  0 */ 	{ "^^xsd:boolean", 							LiteralNotInLexicalSpaceException.class },										// wrong value format
			...
			/*  0 */ 	{ "?var@?lang^^xsd:boolean", 				matcher(_var("var"),			_var("lang"), 	_typ(XSD, BOOLEAN)) }, 			// test variable value and lang
			...
			/*  0 */ 	{ "?var@?lang^^xsd:hexBinary", 				matcher(_var("var"),			_var("lang"), 	_typ(XSD, HEX_BINARY)) }, 		// test variable value and lang
			...
			// xsd:dateTimeStamp
			// Misc
			/*  0 */ 	{ "test string^rdf:XMLLiteral", 			matcher(_str("test string^rdf:XMLLiteral"),_any(),_typ(RDF, PLAIN_LITERAL)) }, 	// wrong separator, should be ^^
			/*  0 */ 	{ "test string^rdf:Literal", 				matcher(_str("test string^rdf:Literal"),_any(),	_typ(RDF, PLAIN_LITERAL)) }, 	// wrong separator, should be ^^
