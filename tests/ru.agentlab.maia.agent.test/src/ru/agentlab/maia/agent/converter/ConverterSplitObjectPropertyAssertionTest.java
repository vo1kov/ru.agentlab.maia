...
public class ConverterSplitObjectPropertyAssertionTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { 
			...
			// 2 words
			/*  6 */ { "xxx xxx", 					AnnotationFormatException.class },		// 2 words with space
			/*  7 */ { "123 456", 					AnnotationFormatException.class },		// 2 words with space
			/*  8 */ { "  123  456", 				AnnotationFormatException.class },		// 2 words with first spaces
			/*  9 */ { "123  456  ", 				AnnotationFormatException.class },		// 2 words with last spaces
			/* 10 */ { "  123  456    ", 			AnnotationFormatException.class },		// 2 words with surrounded by spaces
			/* 11 */ { "123 456", 					AnnotationFormatException.class },		// 2 words with space
			/* 12 */ { "123\r\n456", 				AnnotationFormatException.class },		// 2 words with caret return
			/* 13 */ { "123\n456", 					AnnotationFormatException.class },		// 2 words with new line
			/* 14 */ { "\r\n123  456", 				AnnotationFormatException.class },		// 2 words with first new line
			/* 15 */ { "123  456\r\n", 				AnnotationFormatException.class },		// 2 words with last new line
			/* 16 */ { "\r\n123  456\r\n", 			AnnotationFormatException.class },		// 2 words with surrounded by new lines
			/* 17 */ { "123\t456", 					AnnotationFormatException.class },		// 2 words with tabulation
			/* 18 */ { "123	456", 					AnnotationFormatException.class },		// 2 words with tabulation
			/* 19 */ { "123\t\t\t456", 				AnnotationFormatException.class },		// 2 words with multiple tabulations
			/* 20 */ { "123			456", 			AnnotationFormatException.class },		// 2 words with multiple tabulations
			// 3 words
			...
			// 4 words
			/* 36 */ { "xxx xxx xxx xxx", 			AnnotationFormatException.class },		// 4 words with space         
			/* 37 */ { "xxx\rxxx\rxxx\rxxx", 		AnnotationFormatException.class },		// 4 words with caret return  
			/* 38 */ { "xxx\nxxx\nxxx\nxxx", 		AnnotationFormatException.class },		// 4 words with new line      
			/* 39 */ { "xxx\txxx\txxx\txxx", 		AnnotationFormatException.class },		// 4 words with new tabulation
			/* 40 */ { "xxx	xxx	xxx	xxx", 			AnnotationFormatException.class },		// 4 words with new tabulation
			/* 41 */ { "xxx\r\nxxx\txxx\txxx", 		AnnotationFormatException.class },		// 4 words all
			// Special characters
